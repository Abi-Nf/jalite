package app.jalite.com.endpoint.event;
...
import app.jalite.com.endpoint.event.gen.UuidCreated;
import app.jalite.com.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "app.jalite.com.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
